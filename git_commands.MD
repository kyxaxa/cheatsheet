The following text is extracted from http://git-scm.com/ which has an **interactive terminal** to get you going. This is just a quick reference to sum up all the commands
